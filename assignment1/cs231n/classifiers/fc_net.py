...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        self.params['b1'] = np.zeros(hidden_dim)  # Biases initialized to zero

        # Initialize weights and biases for the second layer
        self.params['W2'] = np.random.randn(hidden_dim, num_classes) * weight_scale
        self.params['b2'] = np.zeros(num_classes)  # Biases initialized to zero
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        # Compute the loss and gradient using softmax
